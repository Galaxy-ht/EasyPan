...
EasyPan 是一个**前后端分离的轻量级私有云盘系统**，提供完整的文件生命周期管理。支持大文件**分片上传**、**MD5 秒传**、**视频 M3U8 流式播放**、Office 文档在线预览、文件分享与回收站等高级特性。适用于个人网盘、团队文件共享、企业内部文档管理等场景。体验地址：https://pan.egon.chat/
